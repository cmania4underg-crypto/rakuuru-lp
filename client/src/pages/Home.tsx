    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm">
        <div className="container flex items-center justify-between py-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <a href={`tel:${TEL}`} onClick={() => (window as any).gtag_report_conversion(`tel:${TEL}`)} className="hidden sm:flex items-center gap-1.5 bg-amber-500 text-white font-bold px-3 py-2 rounded text-sm hover:bg-amber-600 transition-colors">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href={`tel:${TEL}`} onClick={() => (window as any).gtag_report_conversion(`tel:${TEL}`)} className="cta-tel flex-1 text-center no-underline">
        ...
        <div className="container">
          ...
          <div className="scroll-reveal mt-10 bg-primary/5 border border-primary/20 rounded-2xl p-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center max-w-lg mx-auto">
              ...
              <a href={`tel:${TEL}`} onClick={() => (window as any).gtag_report_conversion(`tel:${TEL}`)} className="cta-tel no-underline">
                <Phone className="w-5 h-5" />
                今すぐ電話する
              </a>
            </div>
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="container relative z-10 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-xl mx-auto mb-6">
            ...
            <a href={`tel:${TEL}`} onClick={() => (window as any).gtag_report_conversion(`tel:${TEL}`)} className="cta-tel no-underline flex-1 text-base py-4">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-white border-t border-gray-200 shadow-2xl">
        <div className="flex">
          ...
          <a href={`tel:${TEL}`} onClick={() => (window as any).gtag_report_conversion(`tel:${TEL}`)} className="flex-1 flex items-center justify-center gap-2 bg-amber-500 text-white font-black text-base py-4 hover:bg-amber-600 active:bg-amber-700 transition-colors no-underline">
            <Phone className="w-5 h-5" />
            <span>今すぐ電話</span>
          </a>
        </div>
